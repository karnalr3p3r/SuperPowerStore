...
import RenderPower from "./PowersList";
...
export default function SuperPower() {
    ...
    const mappr = listOfPowers.map((power) => 
        <h1 key={power.name}>Super Power is {power.name} and you can do {power.detail}.</h1>
      
      )
      const mapnum = listr.map(num => <h1>{num}</h1>)
